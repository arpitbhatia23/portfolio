...
const Projects = () => {
  ...
  return (
  <div className='max-w-screen-[100vw] h-screen bg-gradient-to-b from-black to-gray-600'>
<div className=' text-white text-3xl mb-3 h-20 flex items-center justify-center'> Projects</div>
    <div name="Projects" className='  justify-items-center items-center   grid grid-cols-2   space-x-0 md:space-x-20  md:flex md:flex-row md:justify-center '>

{projects.map(({id,link,image,projectname})=>(
  <div key={id} className=' border-2 border-orange-600  gap-3 my-4 w-40 h-44  rounded-xl grid  grid-cols-1 items-end justify-items-center  md:h-64 md:w-60 shadow-xl shadow-orange-600  '>
