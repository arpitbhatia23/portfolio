...
function Dashboard() {
  ...
  return (
    ...
    <div className='  min-w-[100vw ]sm:max-w-screen-lg mx-auto flex flex-col items-center  justify-end md:justify-end md:items-center   h-60   px-3  text-2xl sm:text-3xl space-x-2 ' >
